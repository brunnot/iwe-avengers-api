...
public class AvengerDAO {
	...
	public AvengerDAO(  ) {
		this.mapper.put("aaaa-bbbb-cccc-dddd", new Avenger("aaaa-bbbb-cccc-dddd", "Iron Man", "Tony Stark"));
	}
...
//		newAvenger.setId( "aaaa-bbbb-cccc-dddd" );
		newAvenger.setId( new Random().nextInt(100) + "aaaa" );
		return newAvenger;
	}
